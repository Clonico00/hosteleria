<div class="container mt-5">
    ...
    $curso = (new Curso())->getOne($_SESSION['idCurso']);
    ...
    <form action="cursoedit" method="POST">
        <input type="hidden" name="id" value="<?= $curso[0]['id'] ?>">
        <div class="form-group">
            <label for="nombre">Nombre:</label>
            <input type="text" class="form-control" id="nombre" name="nombre" value="<?= $curso[0]['nombre'] ?>">
        </div>
        <div class="form-group">
            <label for="descripcion">Descripción:</label>
            <input class="form-control" id="descripcion" name="descripcion" value="<?= $curso[0]['descripcion'] ?>">
        </div>
        <?php
